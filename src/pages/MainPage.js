...
import main1mj from "../assets/main1mj.jpg";
import main2mj from "../assets/main2mj.jpg";
import main3mj from "../assets/main3mj.jpg";
...
function MainPage(props) {
  ...
  useEffect(() => {
    const callback = (entries, observer) => {
      console.log("two colum observer ", entries);
      entries.forEach((entry, index) => {
        console.log("two colum entry ", entry, index);
  ...
  return (
    <div className="MainPage -mt-16">
      ...
      <div className="mx-auto">
        <ThreeColumns
          columns={[
            <Card image={main1mj} webp={main1}>
              롱보드는 아주 재밌습니다.
            </Card>,
            <Card image={main2mj} webp={main2}>
              롱보드를 타면 아주 신납니다.
            </Card>,
            <Card image={main3mj} webp={main3}>
              롱보드는 굉장히 재밌습니다.
            </Card>,
          ]}
        />
